...
class Rfid_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $filters = array('name', 'tag', 'dev_id'); // filters to apply to when searching for items
	public $required = array('name', 'tag', 'dev_id'); // an array of required fields. If a key => val is provided, the key is name of the field and the value is the error message to display
	...
	{
		parent::__construct('rfid_tags'); // table name
	}
}

class Rfids_model extends Base_module_record {
